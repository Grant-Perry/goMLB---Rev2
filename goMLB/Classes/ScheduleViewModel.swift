...
class ScheduleViewModel: ObservableObject {
   ...
   init(mockData: Bool) {
	  if mockData {
		 self.teams = [
			["teamName": "Arizona Diamondbacks", "teamLogo": "https://a.espncdn.com/i/teamlogos/mlb/500/ari.png", "teamColor": "AA1F2E", "teamAltColor": "000000"],
			["teamName": "Chicago Cubs", "teamLogo": "https://a.espncdn.com/i/teamlogos/mlb/500/chc.png", "teamColor": "0E3386", "teamAltColor": "CC3433"]
		 ]
		 self.selectedTeam = self.teams.first
		 self.schedule = [
			["date": "2024-06-23", "displayDate": "Sunday, June 23", "time": "7:10 PM EST", "matchup": "Arizona Diamondbacks vs Chicago Cubs", "location": "Chase Field"]
		 ]
		 self.dateRange = "Games for: June 22 - July 2"
	  } else {
		 fetchTeams()
	  }
   }
   ...
   func getTeamLogoURL(teamName: String) -> String {
	  return teams.first(where: { $0["teamName"] == teamName })?["teamLogo"] ?? ""
   }
}
